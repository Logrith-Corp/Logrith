...
const PRODUCTS = [
  ...
  },
  {
    ...
    longDescription: "A complete Notion operating system for early-stage founders — roadmap, CRM, investor tracker, hiring pipeline, and content calendar in one connected workspace. Built from running three startups through zero to launch, refined down to the pieces that actually get used daily.",
    price: 19,
    category: "startups",
    featured: true,
    bestseller: false,
    included: [
      ...
      "Investor & fundraising tracker",
      "Hiring pipeline template",
      "Setup walkthrough video",
    ],
    problemSolves: [
      "Replaces five scattered tools with one workspace",
      "Gives structure without over-engineering process",
      "Ready to use in under ten minutes",
    ],
    faq: [
      { q: "How do I access the file?", a: "You'll receive a Notion duplicate link instantly after checkout." },
